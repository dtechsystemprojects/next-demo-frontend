...
const Contact = () => {
  return (
    <section
      className="section-custom bg-light bg-opacity-30 border-top"
      id="contact"
    >
      <Container>
        <Row>
          <Col xs={12} className="text-center">
            <span className="text-muted rounded-3 d-inline-block">
              📞 Get in Touch
            </span>
              ...
              <div className="d-flex gap-3">
                ...
                <div>
                  ...
                  <h5 className="my-1 lh-lg">
                    UBold HQ, 500 Innovation Drive, Suite 200, Metropolis, NY
                    10101, USA
                  </h5>
                </div>
              </div>
            ...
            <Form className="p-4 border rounded-4 border-dashed">
              <Row className="g-3">
                <Col md={6}>
                  ...
                  <FormControl
                    type="text"
                    className="bg-light bg-opacity-50 border-0 py-2"
                    id="name"
                    autoComplete="name"
